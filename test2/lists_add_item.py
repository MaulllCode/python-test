...
# Menambah item pada "Lists" dengan posisi (indexing) tertentu menggunakan function "insert"# Contoh kita ingin menambahkan 1 item dengan posisi ketiga (indexing = 2)
